    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Factor Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Factor address"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Factor Core"), this);
    aboutAction->setStatusTip(tr("Show information about Factor Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Factor"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Factor addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Factor addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Factor Core help message to get a list with possible Factor command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Factor Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Factor network", "", count));
}
...
{
    QString strTitle = tr("Factor Core"); // default title
