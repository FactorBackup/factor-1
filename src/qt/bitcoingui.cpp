...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and litedash: URIs)"));
    ...
    openAction->setStatusTip(tr("Open a litedash: URI or payment request"));
