    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Litedash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Litedash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and flowercoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Litedash Core"), this);
    aboutAction->setStatusTip(tr("Show information about Litedash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Litedash"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Litedash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Litedash addresses"));
    ...
    openAction->setStatusTip(tr("Open a flowercoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Litedash Core help message to get a list with possible Litedash command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Litedash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Litedash network", "", count));
}
...
{
    QString strTitle = tr("Litedash Core"); // default title
