...
<context>
    ...
    <message>
        ...
        <translation>Не може да стартира factor: кликни за плащане на притежателя</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Съобщението което беше прикрепено към factor: URI ще бъде запазено с транзакцията за ваше сведение. Забележка: Това съобщение няма да бъде изпратено през Factor мрежата.</translation>
    </message>
    <message>
...
for example: alertnotify=echo %%s | mail -s "Factor Alert" admin@foo.com
        ...
        <translation>За използване на factord, или the -server опция към factor-qt, трябва да зададете rpcpassword в конфигурационния файл: %s Препоръчително е да използвате следната произволна парола: rpcuser=factorrpc rpcpassword=%s (не е нужно да запомняте тази парола) Потребителя и паролата НЕ ТРЯБВА да са еднакви. Ако файла не съществува , създайте го с права за само за четене. Препоръчително е да създадете сигнал за уведомяване за да бъдете осведомени при проблем; Пример: alertnotify=echo %%s | mail -s "Factor Alert" admin@foo.com 
</translation>
    </message>
    <message>
