    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Factor Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Factor Core"));
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Factor Core is shutting down...") + "<br /><br />" +
