    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Litedash Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Litedash Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  flowercoin-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Litedash Core is shutting down...") + "<br /><br />" +
