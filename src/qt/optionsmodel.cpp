...
void OptionsModel::Init()
{
    ...
    if (settings.contains("nAnonymizeDarkcoinAmount"))
        SoftSetArg("-anonymizefactoramount", settings.value("nAnonymizeDarkcoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in factor.cpp during shotdown to also remove the window positions
