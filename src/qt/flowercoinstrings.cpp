...
QT_TRANSLATE_NOOP("flowercoin-core", "Copyright (C) 2014-%i The Litedash Core Developers"),
...
QT_TRANSLATE_NOOP("flowercoin-core", "Error loading wallet.dat: Wallet requires newer version of Litedash Core"),
...
QT_TRANSLATE_NOOP("flowercoin-core", "Initialization sanity check failed. Litedash Core is shutting down."),
...
QT_TRANSLATE_NOOP("flowercoin-core", "Wallet needed to be rewritten: restart Litedash Core to complete"),
