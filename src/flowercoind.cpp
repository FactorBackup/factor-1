 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called Litedash (http://www.iondis.io/),
 * which enables instant payments to anyone, anywhere in the world. Litedash uses peer-to-peer technology to operate
...
bool AppInit(int argc, char* argv[])
{
    ...
    {
        std::string strUsage = _("Litedash Core Daemon") + " " + _("version") + " " + FormatFullVersion() + "\n";
    ...
    try
    {
        ...
        if (fDaemon)
        {
            fprintf(stdout, "Litedash server starting\n");
