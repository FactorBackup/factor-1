...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += "  -conf=<file>           " + strprintf(_("Specify configuration file (default: %s)"), "factor.conf") + "\n";
...
#ifndef WIN32
    strUsage += "  -pid=<file>            " + strprintf(_("Specify pid file (default: %s)"), "factord.pid") + "\n";
#endif
    ...
    strUsage += "                           factor (or specifically: darksend, instantx, masternode, keepass, mnpayments, mnbudget)"; // Don't translate these and qt below
    if (mode == HMM_BITCOIN_QT)
        strUsage += ", qt";
    strUsage += ".\n";
#ifdef ENABLE_WALLET
    ...
    strUsage += "  -anonymizefactoramount=<n>     " + strprintf(_("Keep N FACTOR anonymized (default: %u)"), 0) + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    nAnonymizeDarkcoinAmount = GetArg("-anonymizefactoramount", 0);
