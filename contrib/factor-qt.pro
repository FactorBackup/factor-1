...
RESOURCES += src/qt/factor.qrc src/qt/factor_locale.qrc
TRANSLATIONS += src/qt/locale/factor_bg.ts \
                src/qt/locale/factor_de.ts \
                src/qt/locale/factor_en.ts \
                src/qt/locale/factor_es.ts \
                src/qt/locale/factor_fi.ts \
                src/qt/locale/factor_fr.ts \
                src/qt/locale/factor_it.ts \
                src/qt/locale/factor_ja.ts \
                src/qt/locale/factor_pl.ts \
                src/qt/locale/factor_pt.ts \
                src/qt/locale/factor_ru.ts \
                src/qt/locale/factor_sk.ts \
                src/qt/locale/factor_sv.ts \
                src/qt/locale/factor_vi.ts \
                src/qt/locale/factor_zh_CN.ts \
