...
#   c) node1 mines 101 blocks, so now nodes 0 and 1 have 500 FACTOR, node2 has none. 
#   d) node0 sends 21 FACTOR to node2, in two transactions (11 FACTOR, then 10 FACTOR).
...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 21 FACTOR from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 FACTOR in block rewards plus fees, but
