...
Litedash now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month. 
...
- mnbudget "command"... ( "passphrase" )
 ...
 - vote-many          - Vote on a Litedash initiative
 - vote-alias         - Vote on a Litedash initiative
 - vote               - Vote on a Litedash initiative/budget
