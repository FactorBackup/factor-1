...
However, in open source software such as Factor Core, where everyone uses
...
pay attention to for reviewers of Factor Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Factor Core uses tinyformat, which is type safe. Leave them out to avoid confusion
