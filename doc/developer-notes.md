...
- ThreadSocketHandler : Sends/Receives data from peers on port 1993.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 3991 for connections and services them.
...
However, in open source software such as Litedash Core, where everyone uses
...
pay attention to for reviewers of Litedash Core code.

General Litedash Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Litedash Core uses tinyformat, which is type safe. Leave them out to avoid confusion
