...
Only requiring some minor changes is factor.cpp.
...
Changes to factor.cpp
----------------------
factor.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
