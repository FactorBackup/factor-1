...
Only requiring some minor changes is litedash.cpp.
...
Changes to litedash.cpp
----------------------
litedash.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
